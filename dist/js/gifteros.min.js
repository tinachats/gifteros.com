    ...
    var output = `
        ...
        <div class="flex-column justify-content-center w-100 text-center mt-2">
            ...
            <div class="d-block text-center position-relative">
                <h5 class="display-5 my-0 py-0 font-600">4.5</h5>
                ...
                <h6 class="text-muted text-center font-600 my-0 py-0">1233 total reviews</h6>
            </div>
            <!-- /.Rating Stats -->
            ...
            <!-- /.Progress Bar Rating -->
            <a href="#" class="text-center mt-2 text-underline">See more reviews</a>
        </div>
        <!-- /.Gift Rating Metrics -->
    `;
    return output;
