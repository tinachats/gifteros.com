// Date and time functions .gift-cart-options
var today = new Date();
...
// Cart details
var gift_id, post_id, user_id, gift_name, gift_image;
var gift_quantity = 1;
var gift_ids = [];
...
(function countdownTimer(countdown_date, now) {
    countdown_date = new Date('Mar 17, 2021 00:00:00').getTime();
    now = today.getTime();
...
$(function() {
    ...
    $('.popover-info').popover({
        ...
        $('.popover-toggle-icon').html('expand_less');
        var _this = this;
        $(this).popover('show');
        ...
        $('.popover-toggle-icon').html('expand_more');
        var _this = this;
        setTimeout(function() {
